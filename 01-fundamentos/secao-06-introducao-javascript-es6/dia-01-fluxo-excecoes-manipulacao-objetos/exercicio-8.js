...
const frequencyCounter = () => {
    ...
    let counter = 0;
    for (let o of arr) {
        if (o.materia === 'Matemática') {
            counter += o.numeroEstudantes;
        }
    }
    return counter;
}
...
const createReport = (object, professor) => {
    ...
    const classes = [];
    let counter = 0;
    professorReport.professor = professor;
    for (let o of arr) {
        if (o.professor === professor) {
            classes.push(o.materia);
            counter += o.numeroEstudantes;
        }
    }
    professorReport.aulas = classes;
    professorReport.estudantes = counter;
